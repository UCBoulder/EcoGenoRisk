...
plot = sns.swarmplot(data=combined, x='Difference Score', y='Biome', hue = 'Biome', s=2, legend = False)
plot.set_xlabel('Difference Score', fontsize=15)
plot.set_ylabel('Biome', fontsize=15)
plt.show()